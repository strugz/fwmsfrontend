          ...
          <v-layout row wrap>
            ...
            <v-flex xs12 class="mt-2">
              <span class="font-weight-bold">{{
                fieldSearch.ACCMNM == null ? '' : 'Name Of Hospital: ' + fieldSearch.ACCMNM
              }}</span>
            </v-flex>
            <v-flex xs12 class="mt-2">
              <span class="font-weight-bold">{{
                fieldSearch.ACCMAD == null ? '' : 'Complete Address: ' + fieldSearch.ACCMAD
              }}</span>
            </v-flex>
            <v-flex xs12 class="mt-2">
              <span class="font-weight-bold">{{
                fieldSearch.ACCMPH == null ? '' : 'Contact Number: ' + fieldSearch.ACCMPH
              }}</span>
            </v-flex>
