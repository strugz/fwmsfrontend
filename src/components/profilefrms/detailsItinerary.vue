            ...
            <v-card-text class="grey lighten-3">
              <template v-if="CurSRDetails.header">
                <v-flex v-if="CurThreadDetails.TRDSEC == 'Itinerary'">
                  <app-label header="Date & Time Visited:" :detail="CurThreadDetails.TRDMCD"></app-label>
                </v-flex>
              </template>
              <template>
                <v-flex>
                  <app-label header="Visited By:" :detail="this.CurUserDetails.CNTMST.CNTMCN"></app-label>
                </v-flex>
              </template>
              <template>
                <v-flex>
                  <app-label header="Customer:" :detail="CurCSTMST.CSTNME"></app-label>
                </v-flex>
              </template>
              <template>
                <v-flex>
                  <app-label header="Specialty/ Position :" :detail="CurCSTMST.CSTPOS"></app-label>
                </v-flex>
              </template>
              <template>
                <v-flex>
                  <app-label header="User / Non-User:" :detail="CurCSTMST.CSTSTS"></app-label>
                </v-flex>
              </template>
              <template>
                <v-flex>
                  <app-label header="Classification" :detail="CurCSTMST.CSTCLS"></app-label>
                </v-flex>
              </template>
              <template>
                <v-flex>
                  <app-label header="Target Product" :detail="CurCSTMST.CSTTPR"></app-label>
                </v-flex>
              </template>
              <template>
                <v-flex>
