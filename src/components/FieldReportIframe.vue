            ...
            <div class="sr-outbox-content">
                <template v-if="iframeUrl">
                    <div class="fr-iframe-inner" :style="innerStyle">
                        <iframe :src="iframeUrl" frameborder="0" allowfullscreen class="fr-iframe"
                ...
                <template v-else>
                    <div class="d-flex align-center justify-center fill">
                        <p class="pa-4">
                            Missing iframeUrl. Provide it via route params or route query: /fieldreport/:SRID/:ClientID
                            or
