            ...
            <v-dialog v-model="dialog" max-width="500" persistent>
              <v-card>
                ...
                <v-card-text>
                  ...
                  confidential and proprietary to the company. You agree to maintain the confidentiality of this
                  information and not to disclose or share it with any third parties without prior written consent from
                  the company.
                </v-card-text>
